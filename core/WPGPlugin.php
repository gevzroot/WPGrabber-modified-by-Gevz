  ...
  class WPGPlugin {
    ...
    public static function menu() {
      if (function_exists('add_menu_page')) {
        $hook = add_menu_page('WPGrabber', 'WPGrabber', 'edit_pages', 'wpgrabber-index', array(wpgPlugin(), 'index'));
        add_action('load-'.$hook, array(wpgPlugin(), 'addListOptions'));
      }
      if (function_exists('add_submenu_page')) {
        add_submenu_page('wpgrabber-index', 'Список лент', 'Список лент', 'edit_pages', 'wpgrabber-index', array(wpgPlugin(), 'index'));
        add_submenu_page('wpgrabber-index', 'Новая лента', 'Новая лента', 'edit_pages', 'wpgrabber-edit', array(wpgPlugin(), 'edit'));
        add_submenu_page('wpgrabber-index', 'Импорт лент', 'Импорт лент', 'edit_pages', 'wpgrabber-import', array(wpgPlugin(), 'import'));
        add_submenu_page('wpgrabber-index', 'Настройки', 'Настройки', 'edit_pages', 'wpgrabber-settings', array(wpgPlugin(), 'settings'));
      }
    }
